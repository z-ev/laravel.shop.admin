    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="{{Route('blog.admin.orders.index')}}"><i class="fa fa-shopping-cart"></i> <span>Заказы {{--$countOrders--}}</span></a></li>



                <li class="treeview">
                    <a href="#"><i class="fa fa-navicon"></i> <span>Категории {{--$countCategories--}}</span>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-cubes"></i> <span>Товары {{--$countProducts--}}</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
                ...
                <li class="treeview">
                    <a href="#"><i class="fa fa-users"></i> <span>Пользователи {{--$countUsers--}}</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
                    </a>
...
<i class="fa fa-angle-left pull-right"></i>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2020  Powered by EZ</strong>
    </footer>
