                        ...
                        <div class="table-responsive">
                            <form action="{{route('blog.admin.orders.save',$item->id)}}" method="post">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        <td>Комментарий</td>
                                        <td><textarea type="text" id="order_area"
                                                      placeholder="@if (!isset($order->note))комментариев нет @endif" name="comment">@if (isset($order->note)){{$order->note}} @endif</textarea></td>
                                    </tr>
                                    </tbody>
                                </table>
